...
The plugin admin (including the “Ask for review” prompt) is translated into the following languages. Set your site or admin language in **Settings → General** to use them.
...
4. The privacy menu here you can separately change the link or URL to your privacy policy.
5. This is how the cookie banner looks like in fullscreen mode.
6. This is how the cookie banner looks like in compact mode.
...
= 3.4.2 =
Fixed small bugs & updated the plugin´s readme file.
= 3.4.1 =
...
= 1.0.2 =
Added CCPA – California Consumer Privacy Act to the banner. it is currently under development and only showing the user a link to your CCPA policy.
= 1.0.1 =
