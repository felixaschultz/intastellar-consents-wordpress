<?php
/*
Plugin Name: Intastellar Consents Solutions, by Intastellar Solutions, International
...
add_action('plugins_loaded', function () {
    if (isset($_SERVER["REQUEST_URI"]) && !str_contains(sanitize_url(wp_unslash($_SERVER["REQUEST_URI"])), 'wp-admin')) {
        wp_enqueue_script("intastellar-gdpr-settings", "https://consents.cdn.intastellarsolutions.com/uc.js?utm_source=Intastellar+GDPR+Wordpress+Plugin", [
            "in_footer" => false
        ], '3.3');
    }
