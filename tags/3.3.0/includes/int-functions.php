...
function intastellarSettingsRegistration()
{
    ...
    register_setting('intastellar-consents_plugin_options_group', 'intastellarSiteRoot', 'sanitize_text_field');
...
function initIntastellarAdminStyles()
{
    ...
    wp_enqueue_script('intastellarScript', plugin_dir_url(__FILE__) . 'intastellarAdminScript.js', [
        "in_footer" => true
    ], '3.3');
}
        ...
        <section class="intastellarPluginGrid">
            ...
            <div class="intastellarPluginContent">
                ...
                <form method="post" action="options.php" enctype="multipart/form-data">
                    ...
                    <!-- <section id="text" class="intastellarPluginContent__items">
                        <span>None fullscreen? <span class="intastellarPluginContent__items-viewImage">(?) <img src="<?php echo esc_html(sanitize_text_field(plugin_dir_url(__FILE__))) ?>/settings_page.png" class="IntastellarCookieSettingsPage__Image"></span></span>
                        <section>
                            <input type="radio" class="regular-text --radio" name="intastellarDisplayCookieAdvenced" value="true" <?php echo esc_html(sanitize_text_field(($intastellarDisplayCookieAdvencedvalue == 'true' ? 'checked="checked"' : ''))); ?> /> Yes
                            <input type="radio" class="regular-text --radio" name="intastellarDisplayCookieAdvenced" value="false" <?php echo esc_html(sanitize_text_field(($intastellarDisplayCookieAdvencedvalue == 'false' || $intastellarDisplayCookieAdvencedvalue == '' ? 'checked="checked"' : ''))); ?> /> No
                        </section>
                    </section> -->
                    ...
                    <input type='hidden' class="regular-text" id="intastellarPrivacyLink_id" name="intastellarPrivacyLink" required value="<?php echo esc_html(sanitize_text_field(get_option('intastellarPrivacyLink'))); ?>">
                    <input type="hidden" id="intastellarPrivacyLink-checkbox" name="intastellarPrivacyLink-checkbox" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarPrivacyLink-checkbox'))); ?>">
        ...
        <section class="intastellarPluginGrid">
            ...
            <div class="intastellarPluginContent">
                ...
                <form method="post" action="options.php" enctype="multipart/form-data">
                    ...
                    <input type='hidden' class="regular-text --fullWidth" id="intastellarCustomIcon_id" name="intastellarCustomIcon" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarCustomIcon'))); ?>">
                    <input type="hidden" name="intastellarSetCookiePosition" id="intastellarSetCookiePosition_id" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarSetCookiePosition'))); ?>">
                    <input type='hidden' class="regular-text --color" id="intastellarCookieBannerColor_id" name="intastellarCookieBannerColor" value="<?php if (get_option('intastellarCookieBannerColor')) {
                    ...
                    <input type="hidden" name="intastellarDisplayCookieAdvenced" id="intastellarDisplayCookieAdvenced" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarDisplayCookieAdvenced'))); ?>">
                    <input type="hidden" name="intastellarDisplayCookieNoticeText" id="intastellarDisplayCookieNoticeText" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarDisplayCookieNoticeText'))); ?>">
                    <input type="hidden" class="regular-text --color" id="intastellarCookieBanner-brandName" value="<?php if (get_option('intastellarCookieBanner-brandName')) {
                                                                                                                        echo esc_html(sanitize_text_field(get_option('intastellarCookieBanner-brandName')));
                                                                                                                    } else {
                                                                                                                        echo esc_html(sanitize_text_field(get_bloginfo("name")));
        ...
        <section class="intastellarPluginGrid">
            ...
            <div class="intastellarPluginContent">
                ...
                <form method="post" action="options.php" enctype="multipart/form-data">
                    ...
                    <input type="hidden" id="intastellarSelectLanguage_id" name="intastellarSelectLanguage" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarSelectLanguage'))); ?>">
                    <input type="hidden" id="intastellarSelectLanguage_id" name="intastellarSiteRoot" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarSiteRoot'))); ?>">
                    <input type='hidden' class="regular-text --fullWidth" id="intastellarCustomIcon_id" name="intastellarCustomIcon" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarCustomIcon'))); ?>">
                    <input type='hidden' class="regular-text --color" id="intastellarCookieBannerColor_id" name="intastellarCookieBannerColor" value="<?php if (get_option('intastellarCookieBannerColor')) {
                                                                                                                                                            echo esc_html(sanitize_text_field(get_option('intastellarCookieBannerColor')));
                                                                                                                                                        } else {
                    ...
                    <input type="hidden" name="intastellarSetCookiePosition" id="intastellarSetCookiePosition_id" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarSetCookiePosition'))); ?>">
                    <input type="hidden" name="intastellarSiteRoot" id="intastellarSetCookiePosition_id" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarSiteRoot'))); ?>">
                    <input type="hidden" class="regular-text --color" id="intastellarCookieBanner-brandName" value="<?php if (get_option('intastellarCookieBanner-brandName')) {
                                                                                                                        echo esc_html(sanitize_text_field(get_option('intastellarCookieBanner-brandName')));
                                                                                                                    } else {
                                                                                                                        echo esc_html(sanitize_text_field(get_bloginfo("name")));
            ...
            <div class="intastellarPluginContent">
                ...
                <form method="post" action="options.php" enctype="multipart/form-data">
                    ...
                    <section id="logo" class="intastellarPluginContent__items">
                        ...
                        <section>
                            <img src="<?php echo esc_html(sanitize_text_field(get_option('intastellarCustomIcon'))); ?>" class="intastellarCookieSettingsLogo">
                            <input type='text' class="regular-text --fullWidth" id="intastellarCustomIcon_id" name="intastellarCustomIcon" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarCustomIcon'))); ?>">
                        </section>
                    </section>
                    <input type='hidden' class="regular-text" id="intastellarPrivacyLink_id" name="intastellarPrivacyLink" required value="<?php echo esc_html(sanitize_text_field(get_option('intastellarPrivacyLink'))); ?>">
                    <input type="hidden" id="intastellarSelectLanguage_id" name="intastellarSelectLanguage" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarSelectLanguage'))); ?>">
                    ...
                    <input type="hidden" name="intastellarDisplayCookieAdvenced" id="intastellarDisplayCookieAdvenced" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarDisplayCookieAdvenced'))); ?>">
                    <input type="hidden" name="intastellarDisplayCookieNoticeText" id="intastellarDisplayCookieNoticeText" value="<?php echo esc_html(sanitize_text_field(get_option('intastellarDisplayCookieNoticeText'))); ?>">
                    <input type="hidden" name="intastellarSiteRoot" class="regular-text" id="rootDomain" value="<?php echo esc_html(sanitize_text_field(get_option("intastellarSiteRoot"))); ?>">
                    <input type="hidden" name="intastellarBannerStyle" value="<?php if (get_option('intastellarBannerStyle')) {
                                                                                    echo esc_html(sanitize_text_field(get_option('intastellarBannerStyle')));
                                                                                } else {
                                                                                    echo esc_html(sanitize_text_field("overlay"));
