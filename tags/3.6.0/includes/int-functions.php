...
function intastellar_dashboard_widget_render()
{
    ...
    echo '<span class="intastellar-dashboard-widget__card-label">' . esc_html__('Banner Status', 'intastellar-consents') . '</span>';
    ...
    echo '<a href="https://developers.intastellarsolutions.com/cookie-solutions/docs" target="_blank" rel="noopener noreferrer">' . esc_html__('Documentation', 'intastellar-consents') . '</a>';
    echo ' <span class="intastellar-dashboard-widget__footer-sep">·</span> ';
    echo '<a href="https://www.intastellarsolutions.com/solutions/cookie-consents" target="_blank" rel="noopener noreferrer">' . esc_html__('Intastellar Solutions', 'intastellar-consents') . '</a>';
    echo '</div>';
...
function intastellar_dashboard_render()
{
    ...
    $branding_url   = admin_url('admin.php?page=intastellar-consents/branding');
    $cookie_settings_url = admin_url('admin.php?page=intastellar-consents/settings');
    $privacy_url    = admin_url('admin.php?page=intastellar-consents/privacy');
    if (! function_exists('is_plugin_active')) {
        include_once ABSPATH . 'wp-admin/includes/plugin.php';
    }
    ...
    echo '<span class="intastellar-settings-dashboard__card-label">' . esc_html__('Branding', 'intastellar-consents') . '</span>';
    ...
    if ($logo_url) {
        ...
        echo '<span class="intastellar-settings-dashboard__no-logo">' . esc_html__('No logo', 'intastellar-consents') . '</span>';
    }
    echo '</div>';
    echo '<span class="intastellar-settings-dashboard__card-action">' . esc_html__('Configure branding', 'intastellar-consents') . ' &rarr;</span>';
    echo '</a>';
    ...
    echo '<span class="intastellar-settings-dashboard__card-label">' . esc_html__('Language', 'intastellar-consents') . '</span>';
    echo '<span class="intastellar-settings-dashboard__card-value">' . esc_html($banner_label) . '</span>';
    echo '<span class="intastellar-settings-dashboard__card-action">' . esc_html__('Change language', 'intastellar-consents') . ' &rarr;</span>';
    echo '</a>';

    // Banner Settings card
    echo '<a href="' . esc_url($cookie_settings_url) . '" class="intastellar-settings-dashboard__card intastellar-settings-dashboard__card--link">';
    echo '<span class="intastellar-settings-dashboard__card-label">' . esc_html__('Banner Settings', 'intastellar-consents') . '</span>';
    echo '<span class="intastellar-settings-dashboard__card-value">' . esc_html($display_configured) . '</span>';
    echo '<span class="intastellar-settings-dashboard__card-action">' . esc_html__('Placement, domain, more', 'intastellar-consents') . ' &rarr;</span>';
    echo '</a>';
    ...
    echo '<span class="intastellar-settings-dashboard__card-label">' . esc_html__('Privacy policy', 'intastellar-consents') . '</span>';
    echo '<span class="intastellar-settings-dashboard__card-value">' . esc_html($privacy_value) . '</span>';
    echo '<span class="intastellar-settings-dashboard__card-action">' . esc_html__('Configure privacy', 'intastellar-consents') . ' &rarr;</span>';
    echo '</a>';
...
function initIntastellarSettingsPage()
{
    ...
    $menu_position = 2;
    add_menu_page('Intastellar CMP', 'Intastellar CMP', 'manage_options', 'intastellar-consents', 'intastellarGDPRSettingsForm', intastellar_get_menu_icon_url(), $menu_position);
    add_submenu_page("intastellar-consents", "Dashboard", "Dashboard", "manage_options", "intastellar-consents", "intastellarGDPRSettingsForm", null);
    ...
    <section class="intastellarPluginContent">
        ...
        <section class="intastellarPluginGrid">
            <div class="intastellarPluginContent">
                    ...
                    <form method="post" action="options.php" enctype="multipart/form-data" class="intastellar-settings-page__form">
                        ...
                        <div class="intastellar-settings-page__cards">
                            <div class="intastellar-settings-page__card intastellar-settings-page__card--wide">
                                <label class="intastellar-settings-dashboard__card-label"><?php esc_html_e('Banner style', 'intastellar-consents'); ?></label>
                            ...
                            <div class="intastellar-settings-page__card">
                                <label for="intastellarSetCookiePosition_id" class="intastellar-settings-dashboard__card-label"><?php esc_html_e('Placement', 'intastellar-consents'); ?></label>
                                <select name="intastellarSetCookiePosition" class="intastellar-settings-page__input" id="intastellarSetCookiePosition_id">
                                    <option value="ltr" <?php selected($value1, 'ltr'); ?>><?php esc_html_e('Left', 'intastellar-consents'); ?></option>
                                    <option value="rtl" <?php selected($value1, 'rtl'); ?>><?php esc_html_e('Right', 'intastellar-consents'); ?></option>
                                </select>
                            </div>
                            ...
                            <div class="intastellar-settings-page__card">
                                <label for="intastellarSelectLanguage_id" class="intastellar-settings-dashboard__card-label"><?php esc_html_e('Language', 'intastellar-consents'); ?></label>
                                <select id="intastellarSelectLanguage_id" class="intastellar-settings-page__input" name="intastellarSelectLanguage">
                                    <option value="auto" <?php selected($language, 'auto'); ?>><?php esc_html_e('Auto detect', 'intastellar-consents'); ?></option>
                                    <option value="danish" <?php selected($language, 'danish'); ?>><?php esc_html_e('Danish', 'intastellar-consents'); ?></option>
                                    <option value="dutch" <?php selected($language, 'dutch'); ?>><?php esc_html_e('Dutch', 'intastellar-consents'); ?></option>
                                    <option value="english" <?php selected($language, 'english'); ?>><?php esc_html_e('English', 'intastellar-consents'); ?></option>
                                    <option value="french" <?php selected($language, 'french'); ?>><?php esc_html_e('French', 'intastellar-consents'); ?></option>
                                    <option value="finnish" <?php selected($language, 'finnish'); ?>><?php esc_html_e('Finnish', 'intastellar-consents'); ?></option>
                                    <option value="german" <?php selected($language, 'german'); ?>><?php esc_html_e('German', 'intastellar-consents'); ?></option>
                                    <option value="italian" <?php selected($language, 'italian'); ?>><?php esc_html_e('Italian', 'intastellar-consents'); ?></option>
                                    <option value="norwegian" <?php selected($language, 'norwegian'); ?>><?php esc_html_e('Norwegian', 'intastellar-consents'); ?></option>
                            ...
                            <div class="intastellar-settings-page__card intastellar-settings-page__card--wide">
                                <label for="cookieList" class="intastellar-settings-dashboard__card-label"><?php esc_html_e('Strictly Necessary Cookies', 'intastellar-consents'); ?></label>
                                <p class="intastellar-settings-page__hint"><?php esc_html_e('These cookies are always set and cannot be disabled because they are required for core functionality. Comma-separated or one per line.', 'intastellar-consents'); ?></p>
                            ...
                            <div class="intastellar-settings-page__card">
                                <label class="intastellar-settings-dashboard__card-label"><?php esc_html_e('Display cookie notice text', 'intastellar-consents'); ?></label>
                ...
                <p class="intastellar-settings-page__footer"><?php esc_html_e('You can also read the docs and download the newest version:', 'intastellar-consents'); ?> <a href="https://developers.intastellarsolutions.com/cookie-solutions/docs/wordpress-docs?utm_medium=wordpress_plugin&utm_source=<?php echo esc_url(isset($_SERVER['HTTP_HOST']) ? sanitize_url(wp_unslash($_SERVER['HTTP_HOST'])) : ''); ?>" target="_blank" rel="noopener"><?php esc_html_e('Intastellar GDPR cookie banner', 'intastellar-consents'); ?></a></p>
    ...
    <section class="intastellarPluginContent">
        ...
        <section class="intastellarPluginGrid">
            <div class="intastellarPluginContent">
                    ...
                    <form method="post" action="options.php" enctype="multipart/form-data" class="intastellar-branding-page__form">
                        ...
                        <div class="intastellar-branding-page__cards">
                            <div class="intastellar-branding-page__card">
                                <label for="intastellarCookieBanner-brandName" class="intastellar-settings-dashboard__card-label"><?php esc_html_e('Company name', 'intastellar-consents'); ?></label>
                                <input type="text" class="intastellar-branding-page__input" id="intastellarCookieBanner-brandName" name="intastellarCookieBanner-brandName" value="<?php echo esc_attr($brand_name); ?>" placeholder="<?php esc_attr_e('Your company name', 'intastellar-consents'); ?>">
                            </div>

                            <div class="intastellar-branding-page__card">
                                <label for="intastellarCookieBannerColor_id" class="intastellar-settings-dashboard__card-label"><?php esc_html_e('Brand color', 'intastellar-consents'); ?></label>
                            ...
                            <div class="intastellar-branding-page__card">
                                <label for="intastellarCustomIconButton" class="intastellar-settings-dashboard__card-label"><?php esc_html_e('Company logo', 'intastellar-consents'); ?></label>
                                <div class="intastellar-branding-page__card-preview">
                                    <div class="intastellar-branding-page__preview-logo-wrap">
                                        ...
                                        <?php else : ?>
                                            <span class="intastellar-branding-page__preview-no-logo" id="intastellarBrandingPreviewPlaceholder"><?php esc_html_e('No logo', 'intastellar-consents'); ?></span>
                                            <img src="" alt="" class="intastellar-branding-page__preview-logo" id="intastellarCustomIconPreview" style="display:none">
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <p class="intastellar-branding-page__hint"><?php esc_html_e('Recommended: max-width 200px, min-width 100px for near-square logos.', 'intastellar-consents'); ?></p>
                ...
                <p class="intastellar-branding-page__footer"><?php esc_html_e('You can also read the docs or download the newest version:', 'intastellar-consents'); ?> <a href="https://developers.intastellarsolutions.com/cookie-solutions/docs/wordpress-docs?utm_medium=wordpress_plugin&utm_source=<?php echo esc_url(isset($_SERVER['HTTP_HOST']) ? sanitize_url(wp_unslash($_SERVER['HTTP_HOST'])) : ''); ?>" target="_blank" rel="noopener"><?php esc_html_e('Intastellar Consents Solutions', 'intastellar-consents'); ?></a></p>
                <?php include("intastellarGDPRAdminPanelFooter.php"); ?>
            </div>
        </section>
    </section>
