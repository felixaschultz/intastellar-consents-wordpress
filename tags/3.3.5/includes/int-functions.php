...
{
    register_setting('intastellar-consents_plugin_options-group', 'intastellarCustomIcon', 'esc_url');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarCookieBannerColor', 'sanitize_hex_color');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarCookieBanner-brandName', 'sanitize_text_field');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarPrivacyLink', 'esc_url');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarPrivacyLink-checkbox', 'sanitize_text_field');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarSetCookiePosition', 'sanitize_text_field');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarDisplayCookieNoticeText', 'sanitize_text_field');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarSelectLanguage', 'sanitize_text_field');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarCCPA', 'sanitize_text_field');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarCCPAUrl', 'esc_url');
    register_setting('intastellar-consents_plugin_options-group', "intastellarDisplayCookieAdvenced", 'sanitize_text_field');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarCCPAcollection', 'sanitize_text_field');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarCookieList', 'sanitize_text_field');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarSiteRoot', 'sanitize_text_field');
    register_setting('intastellar-consents_plugin_options-group', 'intastellarBannerStyle', 'sanitize_text_field');
