GPDR Cookie banner, by Intastellar Solutions, International
...
This plugin is loading external JavaScript files one which is the script for the cookiebanner (GitHub: https://github.com/felixaschultz/gdpr-cookiebanner).
...
== Changelog ==
= 3.1.0 =
Added the posibillity to add required cookies to the banner. This is for the user to know, that the website is using cookies that are required for the website to work.
= 2.0.0 =
...
Added a source parameter to the script to find out, wich plugin source the outgoing link is coming from.
= 1.0 =
We've got updated the settings page, where you now can change your color, add a custom logo, add a link to your privacy policy, change the placement of the banner,
choose to show the text "cookie notice" and we´ve added language support and selection. Choose between, german, danish, english and auto detection.