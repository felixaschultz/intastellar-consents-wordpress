<?php
    ...
    */
    ...
    function intastellarSettingsRegistration() {
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', 'intastellarCustomIcon');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', 'intastellarCookieBannerColor');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', 'intastellarCookieBanner-brandName');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', 'intastellarPrivacyLink');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', 'intastellarPrivacyLink-checkbox');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', 'intastellarSetCookiePosition');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', 'intastellarDisplayCookieNoticeText');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', 'intastellarSelectLanguage');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group','intastellarCCPA');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group','intastellarCCPAUrl');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', "intastellarDisplayCookieAdvenced");
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', 'intastellarCCPAcollection');
        register_setting('intastellar-gdpr-cookiebanner_plugin_options_group', 'intastellarCookieList');
    }
    ...
    function loadIntastellarCookieBanner(){
        ...
        wp_add_inline_script( 'intastellar-gdpr-settings',
            'window.INTA = ' . json_encode( array(
                ...
                'settings' => array(
                    ...
                    'requiredCookies' => (str_contains(get_option('intastellarCookieList'), "\n") ) ? expolde("\n", get_option('intastellarCookieList')) : expolde(",", get_option('intastellarCookieList')),
                    'advanced' => $advanced
                ),
            ) ), 
        'after'
        ...
        <section class="intastellarPluginContent">
            ...
            <section class="intastellarPluginGrid">
                <aside class="intastellarPlugin-sideNavigation">
                    <a href="?page=intastellar-gdpr-cookiebanner">Intro</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/branding">Branding</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/settings" class="active">Settings</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/privacy">Privacy Policy</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/help">Help</a>
                </aside>
                <div class="intastellarPluginContent">
                    ...
                    <form method="post" action="options.php" enctype="multipart/form-data">
                        <?php settings_fields('intastellar-gdpr-cookiebanner_plugin_options_group'); ?>
                        ...
                        <section>
                            CCPA policy link:
                            <input type="text" class="regular-text" name="intastellarCCPAUrl" value="<?php if(get_option('intastellarCCPAUrl')){ _e(get_option('intastellarCCPAUrl')); }?>">
                            <p>CCPA personal data to be collect beside of IP-Address:</p>
                            <textarea class="regular-text" name="intastellarCCPAcollection"><?php if(get_option('intastellarCCPAcollection')){ _e(get_option('intastellarCCPAcollection')); }?></textarea>
                        </section> -->
                        ...
                        <input type = 'hidden' class="regular-text --color" id="intastellarCookieBannerColor_id" name="intastellarCookieBannerColor" value="<?php if(get_option('intastellarCookieBannerColor')){ _e(get_option('intastellarCookieBannerColor')); }else{  _e(get_theme_mod( 'background_color' )); } ?>">
                        ...
                        <input type="hidden"  class="regular-text --color" id="intastellarCookieBanner-brandName" value="<?php if(get_option('intastellarCookieBanner-brandName"')){ _e(get_option('intastellarCookieBanner-brandName"')); } else {_e(get_bloginfo("name"));} ?>">
...
<?php	
    ...
    ?>
       <section class="intastellarPluginContent">
            ...
            <section class="intastellarPluginGrid">
                <aside class="intastellarPlugin-sideNavigation">
                    <a href="?page=intastellar-gdpr-cookiebanner" class="active">Intro</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/branding">Branding</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/settings">Settings</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/privacy">Privacy Policy</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/help">Help</a>
                </aside>
                <div class="intastellarPluginContent">
                    <header class="intastellarPluginPage-header">
                        <h3 class="intastellarPluginHeader__headline">Welcome to Intastellar Solutions GDPR Cookiebanner</h3>
                    ...
                    <form method="post" action="options.php" enctype="multipart/form-data">
                        ...
                        <p>You wanna learn more about this cookie banner? Then you can read more under: <a target="_blank" href="https://www.intastellarsolutions.com/gdpr-cookiebanner">intastellarsolutions.com/gdpr-cookiebanner</a></p>
                    ...
                    <p>You can also read the docs or download the newest version: <a href="https://developers.intastellarsolutions.com/gdpr-cookiebanner/docs/wordpress-docs?utm_medium=wordpress_plugin&utm_source=<?php _e($_SERVER["HTTP_HOST"])?>" target="_blank" rel="noopener">Intastellar GDPR cookie banner</a></p>
                    <?php include("intastellarGDPRAdminPanelFooter.php"); ?>
                </div>
            </section>
        </section>
       ...
       <section class="intastellarPluginContent">
            ...
            <section class="intastellarPluginGrid">
                <aside class="intastellarPlugin-sideNavigation">
                    ...
                    <a href="?page=intastellar-gdpr-cookiebanner/branding">Branding</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/settings">Settings</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/privacy" class="active">Privacy Policy</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/help">Help</a>
                </aside>
                <div class="intastellarPluginContent">
                    <header class="intastellarPluginPage-header">
    ...
    ?>
       <section class="intastellarPluginContent">
            ...
            <section class="intastellarPluginGrid">
                <aside class="intastellarPlugin-sideNavigation">
                    <a href="?page=intastellar-gdpr-cookiebanner">Intro</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/branding" class="active">Branding</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/settings" class="">Settings</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/privacy">Privacy Policy</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/help">Help</a>
                </aside>
                <div class="intastellarPluginContent">
                    ...
                    <form method="post" action="options.php" enctype="multipart/form-data">
                        ...
                        <section id="brandname" class="intastellarPluginContent__items">
                            ...
                            <section>
                                <input type="text" class="regular-text" id="intastellarCookieBanner-brandName" name="intastellarCookieBanner-brandName" value="<?php if(get_option('intastellarCookieBanner-brandName')){ _e(get_option('intastellarCookieBanner-brandName')); } else {_e(get_bloginfo("name"));} ?>">
                            </section>
                        </section>
                        <section id="color" class="intastellarPluginContent__items">
                            ...
                            <div class="colorPallet">
                                <input type = 'color' class="regular-text --color" id="intastellarCookieBannerColor_id" name="intastellarCookieBannerColor" value="<?php if(get_option('intastellarCookieBannerColor')){ _e(get_option('intastellarCookieBannerColor')); }else{  _e(get_theme_mod( 'background_color' )); } ?>">
                                <span class="colorValue" id="intastellarCookieBannerColorValue" contenteditable><?php if(get_option('intastellarCookieBannerColor')){ _e(get_option('intastellarCookieBannerColor')); }else{  _e(get_theme_mod( 'background_color' )); } ?></span>
                            </div>
                        </section>
       ...
       <section class="intastellarPluginContent">
            ...
            <section class="intastellarPluginGrid">
                <aside class="intastellarPlugin-sideNavigation">
                    ...
                    <a href="?page=intastellar-gdpr-cookiebanner/settings">Settings</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/privacy">Privacy Policy</a>
                    <a href="?page=intastellar-gdpr-cookiebanner/help" class="active">Help</a>
                </aside>
                <div class="intastellarPluginContent">
                    <h1>Help</h1>
